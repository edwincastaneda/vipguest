	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		<ul class="nav menu">
		<?php if($inicio){ ?> <li class="active"> <?php }else{?><li> <?php } ?>
			<a href="/admin"><span class="glyphicon glyphicon-home"></span> Inicio</a>
		</li>
		<?php if($tarjetas){ ?> <li class="active"> <?php }else{?><li> <?php } ?>
			<a href="widgets.html"><span class="glyphicon glyphicon-envelope"></span> Tarjetas</a>
		</li>
		<?php if($rsvp){ ?> <li class="parent active"> <?php }else{?><li class="parent"> <?php } ?>
			...
			<?php if($regalos){ ?> <li class="active"> <?php }else{?><li> <?php } ?><a href="tables.html"><span class="glyphicon glyphicon-gift"></span> Regalos</a></li>
